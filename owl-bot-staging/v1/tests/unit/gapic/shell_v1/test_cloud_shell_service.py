...
@pytest.mark.parametrize("client_class", [
    CloudShellServiceClient, CloudShellServiceAsyncClient
])
@mock.patch.object(CloudShellServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudShellServiceClient))
@mock.patch.object(CloudShellServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CloudShellServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CloudShellServiceClient, transports.CloudShellServiceGrpcTransport, "grpc", grpc_helpers),
    (CloudShellServiceAsyncClient, transports.CloudShellServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (CloudShellServiceAsyncClient, transports.CloudShellServiceGrpcAsyncIOTransport),
])
